...
public class CheckBox {
	...
	public static void main(String[] args) {
		...
		System.out.println(driver.findElement(By.id("familyandfriend")).isSelected());//input[@type='checkbox']
		driver.findElement(By.id("familyandfriend")).click();
		System.out.println(driver.findElement(By.id("familyandfriend")).isSelected());
		System.out.println(driver.findElement(By.id("familyandfriend")).getSize());
